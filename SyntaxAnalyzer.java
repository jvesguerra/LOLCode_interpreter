...
public class SyntaxAnalyzer {
    ...
    static ArrayList<String> get_tokens(ArrayList<String> final_tokens, ArrayList<String> tokens) {
        ...
        for (int t = 0; t < tokens.size(); t++) {
            build_token = "";
            if (tokens.get(t).equals("I") || tokens.get(t).equals("IS") || tokens.get(t).equals("IM")
                    || tokens.get(t).equals("HOW")) {
                build_token = tokens.get(t) + " " + tokens.get(t + 1) + " " + tokens.get(t + 2);
                if (build_token.equals("I HAS A") || build_token.equals("IM IN YR") || build_token.equals("IM OUTTA YR")
                        || build_token.equals("HOW IZ I") || build_token.equals("IS NOW A")) {
                    final_tokens.add(build_token);
                    t = t + 2; // update loop
                }
                // operations
            } else if (tokens.get(t).equals("SUM") || tokens.get(t).equals("DIFF") || tokens.get(t).equals("PRODUKT")
                    || tokens.get(t).equals("QUOSHUNT") || tokens.get(t).equals("MOD") || tokens.get(t).equals("BIGGR")
                    || tokens.get(t).equals("SMALLR") || tokens.get(t).equals("BOTH") || tokens.get(t).equals("EITHER")
                    || tokens.get(t).equals("WON") || tokens.get(t).equals("ANY") || tokens.get(t).equals("ALL")
                    || tokens.get(t).equals("O") || tokens.get(t).equals("YA") || tokens.get(t).equals("NO")) {
                build_token = tokens.get(t) + " " + tokens.get(t + 1);
                if (build_token.equals("SUM OF") || build_token.equals("DIFF OF") || build_token.equals("PRODUKT OF")
                        || build_token.equals("QUOSHUNT OF") || build_token.equals("MOD OF")
                        || build_token.equals("BIGGR OF") || build_token.equals("SMALLR OF")
                        || build_token.equals("BOTH OF") || build_token.equals("EITHER OF")
                        || build_token.equals("WON OF") || build_token.equals("ANY OF") || build_token.equals("ALL OF")
                        || build_token.equals("BOTH SAEM") || build_token.equals("O RLY?")
                        || build_token.equals("YA RLY") || build_token.equals("NO WAI")) {
                    final_tokens.add(build_token);
                    t = t + 1; // update loop
                }
            } else {
    ...
    static HashMap<String, String> classify_tokens(HashMap<String, String> pairs, HashMap<String, String> map,
            ArrayList<String> final_tokens) {
    ...
    static HashMap<String, String> grammar_map(HashMap<String, String> grammar, HashMap<String, String> map,
        ...
        // {Printing=^VISIBLE -?\d+|VISIBLE [+-]?([0-9]+[.]){1}[0-9]|VISIBLE
        // ".*"|VISIBLE WIN|FAIL$ <- value of Printing
        ...
        grammar.put("WIN TROOF Literal", "^WIN$"); // .substring() doesnt produce correct results kaya inalter muna yung
                                                   // values, should be ^WIN$|^FAIL$
        grammar.put("FAIL TROOF Literal", "^FAIL$");
        grammar.put("Variable Initialization number", "^I HAS A [A-Za-z]+[A-Za-z0-9_]* ITZ [-?\\d+|\"-?\\d+\"]*$");
        // grammar.put("Variable Initialization", "^I HAS A [A-Za-z]+[A-Za-z0-9_]* ITZ
        // (" + map.get("Variable").replaceAll("^.|.$", "")
        // +")$");
        ...
        grammar.put("Printing",
                "^VISIBLE (" + grammar.get("NUMBR Literal").substring(1, grammar.get("NUMBR Literal").length() - 1)
                        + "|"
                        + grammar.get("NUMBAR Literal").substring(1, grammar.get("NUMBAR Literal").length() - 1) + "|" // .substring
    ...
    static ArrayList<String> get_final_syntax_tokens(ArrayList<String> tokens_syntax,
            ArrayList<String> final_syntax_tokens, int tokens_syntax_size) {
        String bs_token = "";
        for (int t = 0; t < tokens_syntax.size(); t++) {
            bs_token = "";
            if (tokens_syntax.get(t).equals("I") || tokens_syntax.get(t).equals("IS")
                    || tokens_syntax.get(t).equals("IM") || tokens_syntax.get(t).equals("HOW")) {
                bs_token = tokens_syntax.get(t) + " " + tokens_syntax.get(t + 1) + " " + tokens_syntax.get(t + 2);
                if (bs_token.equals("I HAS A") || bs_token.equals("IM IN YR") || bs_token.equals("IM OUTTA YR")
                        || bs_token.equals("HOW IZ I") || bs_token.equals("IS NOW A")) {
                    final_syntax_tokens.add(bs_token);
                    t = t + 2; // update loop
                }
                // operations
            } else if (tokens_syntax.get(t).equals("SUM") || tokens_syntax.get(t).equals("DIFF")
                    || tokens_syntax.get(t).equals("PRODUKT") || tokens_syntax.get(t).equals("QUOSHUNT")
                    || tokens_syntax.get(t).equals("MOD") || tokens_syntax.get(t).equals("BIGGR")
                    || tokens_syntax.get(t).equals("SMALLR") || tokens_syntax.get(t).equals("BOTH")
                    || tokens_syntax.get(t).equals("EITHER") || tokens_syntax.get(t).equals("WON")
                    || tokens_syntax.get(t).equals("ANY") || tokens_syntax.get(t).equals("ALL")
                    || tokens_syntax.get(t).equals("O") || tokens_syntax.get(t).equals("YA")
                    || tokens_syntax.get(t).equals("NO")) {
                bs_token = tokens_syntax.get(t) + " " + tokens_syntax.get(t + 1);
                if (bs_token.equals("SUM OF") || bs_token.equals("DIFF OF") || bs_token.equals("PRODUKT OF")
                        || bs_token.equals("QUOSHUNT OF") || bs_token.equals("MOD OF") || bs_token.equals("BIGGR OF")
                        || bs_token.equals("SMALLR OF") || bs_token.equals("BOTH OF") || bs_token.equals("BOTH SAEM")
                        || bs_token.equals("EITHER OF") || bs_token.equals("WON OF") || bs_token.equals("ANY OF")
                        || bs_token.equals("ALL OF") || bs_token.equals("O RLY?") || bs_token.equals("YA RLY")
                        || bs_token.equals("NO WAI")) {
                    final_syntax_tokens.add(bs_token);
                    t = t + 1; // update loop
                }
            } else {
    ...
    static ArrayList<String> build_statements_array(ArrayList<String> statements_array,
            ArrayList<String> final_syntax_tokens) {
        String code_line = "";
    ...
    public static void main(String[] args) {
        ...
        HashMap<String, String> map = new HashMap<String, String>();
        // tokens from the input, this will be the final hashmap which will contain all
        ...
        try {
            File file = new File("comments.txt"); // file name
        ...
        for (int n = 0; n < array.size(); n++) {
            ...
            for (int i = 0; i < token_line_length; i++) { // traverse the token line by char
                ...
                if (string_counter == 0) { // if current_char encounters a white space (newline) while string counter ==
                                           // 0
        ...
        if (tokens_syntax.get(0).equals("HAI") || tokens_syntax.get(tokens_syntax_size).equals("KTHXBYE")) {
            ...
            // correct_syntax = check_correct_syntax(statements_array, grammar,
            // correct_syntax);
            ...
            for (int i = 0; i < statements_array.size(); i++) {
                ...
                for (HashMap.Entry<String, String> set : grammar.entrySet()) {
                    if (Pattern.matches(set.getValue(), statements_array.get(i))) { // comparing yung each regex value
                                                                                    // sa array which containts
                                                                                    // code_line values
                            ...
                            if (pairs.get(temp.get(5)).equals("Repeat loop while WIN")) {
                                if (pairs.get(temp.get(6)).equals("!= Comparison Operator")) {
                                    ...
                                    if (arg1 != arg2) {
                                        ...
                                        next_i = i + 1;
                                        if (run_loop == 1) {
                                            while (!(pairs.get(for_sem_analysis.get(next_i).get(0))
                                                    .equals("End of loop"))) {
                                                oic_index += 1;
                                                next_i += 1;
                                            }
                        ...
                        if (pairs.get(temp.get(0)).equals("Switch-Case Statement")) {
                            ...
                            // ELSE FIND NEXT OMG or default
                                ...
                                while ((!(pairs.get(for_sem_analysis.get(next_i).get(0))
                                        .equals("Switch-Case Statement")))) {
                                    if (pairs.get(for_sem_analysis.get(next_i).get(0))
                                            .equals("Switch-Case Default Statement")) {
                                        break;
                                    }
                                    omg_index += 1;
                                    next_i += 1;
                        ...
                        if (pairs.get(temp.get(0)).equals("Switch-Case/Loop break statement")) {
                            ...
                            if (omg == 1) {
                                while (!(pairs.get(for_sem_analysis.get(next_i).get(0))
                                        .equals("End of If-Else and Switch-Case Statement"))) {
                                    oic_index += 1;
                                    next_i += 1;
                                }
                                i = i + oic_index;
                        ...
                        int op_bypass = 0;
                        int save_to_it = 0;
                        if (pairs.get(temp.get(0)).equals("Addition Operator")
                                || pairs.get(temp.get(0)).equals("Subtraction Operator")
                                || pairs.get(temp.get(0)).equals("Multiplication Operator")
                                || pairs.get(temp.get(0)).equals("Division Operator")
                                || pairs.get(temp.get(0)).equals("Modulo Operator")) {
                            op_bypass = 1;
                            save_to_it = 1;
                        }
                        ...
                        if (pairs.get(temp.get(0)).equals("Variable") || op_bypass == 1) {
                            if (temp.get(1).equals("R") || op_bypass == 1) {
                                if (pairs.get(temp.get(2)).equals("== Comparison Operator")
                                        || pairs.get(temp.get(2)).equals("!= Comparison Operator")) {
                ...
                if (found == false) {
                    ...
                    if (syntax_error_string[0].equals("I")
                        ...
                        if (syntax_error_string.length > 4) {
                            ...
                            if (syntax_error_string.length > 6
                                    && (!syntax_error_string[5].matches("^[a-z]+[A-Za-z0-9_]*$")
                    ...
                    if (syntax_error_string[0].equals("SMOOSH")
                        ...
                        if (syntax_error_string.length > 3) {
                            ...
                            if (syntax_error_string.length > 4) {
                                for (syntax_error_i = temp_i
                                        + 3; syntax_error_i < syntax_error_string.length; syntax_error_i++) {
                                    ...
                                    if (!syntax_error_string[syntax_error_i + 1].matches("^\".*\"$")
                                            || !syntax_error_string[syntax_error_i + 1]
                    ...
                    if (syntax_error_string[0].equals("SUM")
                        ...
                        for (syntax_error_i = 0; syntax_error_i < syntax_error_string.length; syntax_error_i++) {
                            if (syntax_error_string[syntax_error_i].equals("SUM")
                                ...
                                operation_count++;
                                syntax_error_i++;
                            } else if (syntax_error_string[syntax_error_i].matches("^-?\\d+$")
                                    || syntax_error_string[syntax_error_i].matches("^([+-]?\\d*\\.\\d*)$")
                                    || syntax_error_string[syntax_error_i].matches("^[a-z]+[A-Za-z0-9_]*$")// check
                                                                                                           // variable
                                                                                                           // type here
                                    || syntax_error_string[syntax_error_i].matches("^\"-?\\d+\"$")
                                    || syntax_error_string[syntax_error_i].matches("^\"([+-]?\\d*\\.\\d*)\"$")) {
                                // if two numbers or variables are beside each other
                                if (syntax_error_string[syntax_error_i + 1].matches("^-?\\d+$")
                                        || syntax_error_string[syntax_error_i + 1].matches("^([+-]?\\d*\\.\\d*)$")
                                        || syntax_error_string[syntax_error_i + 1].matches("^[a-z]+[A-Za-z0-9_]*$") // check
                                                                                                                    // variable
                                                                                                                    // type
                                                                                                                    // here
                                        || syntax_error_string[syntax_error_i].matches("^\"-?\\d+\"$")
                            ...
                            } else if (syntax_error_string[syntax_error_i].equals("AN")
                        ...
                        if (syntax_error_string[syntax_error_string.length - 1].equals("AN")) {
                            ...
                            if (syntax_error_string.length > 2) {
                                ...
                                if (!(syntax_error_string[1].equals("WIN")
                                        ...
                                        || syntax_error_string[1].matches("^[a-z]+[A-Za-z0-9_]*$"))) { // check variable
                                                                                                       // type here
                                ...
                                || syntax_error_string[0].equals("WON"))
                                && syntax_error_string[1].equals("OF")) {
                            if (!(syntax_error_string[2].equals("WIN")
                    ...
                    if ((syntax_error_string[0].equals("ALL") || syntax_error_string[0].equals("ANY"))
                        ...
                        for (syntax_error_i = 2; syntax_error_i < syntax_error_string.length; syntax_error_i++) {
                            ...
                            if (syntax_error_string[syntax_error_i].equals("NOT")) {
                                if (!(syntax_error_string[syntax_error_i + 1].equals("WIN")
                                        || syntax_error_string[syntax_error_i + 1].equals("FAIL")
                                        || syntax_error_string[syntax_error_i + 1].matches("^[a-z]+[A-Za-z0-9_]*$"))
                                        && syntax_error_i < syntax_error_string.length - 1) { // check variable type
                                                                                              // here
                                    System.out.println("Syntax error: invalid variable type");
                                    error_found = true;
                                    break;
                            ...
                            if ((syntax_error_string[syntax_error_i].equals("BOTH")
                                    || syntax_error_string[syntax_error_i].equals("EITHER")
                                    || syntax_error_string[syntax_error_i].equals("WON"))
                                    && syntax_error_string[syntax_error_i + 1].equals("OF")) {
                                if (!(syntax_error_string[syntax_error_i + 2].equals("WIN")
                                    ...
                                    error_found = true;
                                    break;
                                } else if (!(syntax_error_string[syntax_error_i + 4].equals("WIN")
