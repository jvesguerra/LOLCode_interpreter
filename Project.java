...
public class Project extends javax.swing.JFrame {
        ...
        private static ArrayList<String> tokens = new ArrayList<String>();     // list to save our tokens
        private static ArrayList<String> final_tokens = new ArrayList<String>();
        private static ArrayList<String> tokens_syntax = new ArrayList<String>();     //list to save our tokens
        private static ArrayList<String> final_syntax_tokens = new ArrayList<String>();
        private static ArrayList<String> statements_array = new ArrayList<>(); //new array
        ...
        private static HashMap<String, String> correct_syntax = new HashMap<String, String>(); 
        private static HashMap<Integer, ArrayList<String>> for_sem_analysis = new HashMap<Integer, ArrayList<String>>();
...
/////////////////////////////////////////////////Action Listeners
    ...
    private void uploadButtonActionPerformed(java.awt.event.ActionEvent evt) {                                             
        ...
        try {                                      
            ...
            consoleArea.append("An error occured");
    ...
    void run(){ 
        ...
        DefaultTableModel lexeme_model = (DefaultTableModel) lexemeTable.getModel();
        DefaultTableModel variable_model = (DefaultTableModel) variableTable.getModel();

        for (int row = 0; row < lexemeTable.getRowCount(); row++) {
            lexeme_model.removeRow(row);
        }
        for (int row = 0; row < variableTable.getRowCount(); row++) {
            variable_model.removeRow(row);
        }
        
        String data = codeArea.getText();
        String[] data_split_array = data.split("\\r?\\n");
        System.out.println(data_split_array);
        for(int i = 0; i < data_split_array.length; i++){
            //System.out.println(data_split_array[i]);
            array.add(data_split_array[i].trim());
        }
        ...
        //displaying onto lexeme table in gui
        for (HashMap.Entry<String, String> set : pairs.entrySet()) {
            lexeme_model.addRow(new Object[]{set.getKey(), "keyword", set.getValue(), 1});
        }
                    ...
                    if(Pattern.matches(set.getValue(),statements_array.get(i))){  //comparing yung each regex value sa array which containts code_line values
                        ...
                        if(pairs.get(temp.get(0)).equals("Stores a string input to a variable")){
                            try (Scanner scanner_input = new Scanner(System.in)) {
                                ...
                                consoleArea.append("TYPE SOMETHING AND ENTER");
                                ...
                                consoleArea.append("Can only be saved to a variable");
                        ...
                        if(pairs.get(temp.get(0)).equals("Used for printing a statement")){
                            ...
                            if(temp.size() > 2){
                                ...
                                consoleArea.append(print_statement);

                            }else{
                                if(var_map.containsKey(temp.get(1))){
                                    System.out.println(var_map.get(temp.get(1)));
                                consoleArea.append(var_map.get(temp.get(1)));

                                }else{
                                    System.out.println(temp.get(1));
                                    consoleArea.append(temp.get(1));
                        ...
                        if(pairs.get(temp.get(0)).equals("== Comparison Operator")){
                            ...
                            if(pairs.get(temp.get(3)).equals("max")){
                                ...
                                if(arg1 >= arg2){
                                    ...
                                    consoleArea.append("TRUE");

                                }else{
                                    var_map.put("bool","FALSE");
                                    System.out.println("FALSE");
                                    consoleArea.append("FALSE");
        ...
        //display variables on gui
        for (HashMap.Entry<String, String> set : var_map.entrySet()) {
            variable_model.addRow(new Object[]{set.getKey(), set.getValue(), "default"});
        }
